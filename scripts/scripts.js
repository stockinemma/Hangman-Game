// Function to hide currentWord from console
(function() {
  /*
   * Pick from alphabet keypad. Returns chosen letter.
   */
  ...
  function handlePickedLetter(letterPicked) {
    ...
    //if resultMatches is greater than 0 place them in the dom
    ...
    //if letterBlock is not greater than 0 place letter in graveyard
    } else {
  ...
  // Next 2 lines to be refactored for
  ...
  var hangmanWords = [
    "alabama","alaska","arizona","arkansas","california","colorado","connecticut","delaware","florida","georgia","hawaii",
     "idaho","illinoise","indiana","iowa","kansas","kentucky","louisiana","maine","maryland","massachusetts","michigan",
  ...
  function setWordToBeGuessed(){
    ...
    currentWordFull = wordSelect(hangmanWords);//Replace number with wordSelect (the function)

    //set an all upper case version of the current word to show where there are letters and spaces
